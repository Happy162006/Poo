                    ...
                    <section class="bg-white rounded-lg shadow mx-4 my-6">
                        ...
                        <div class="flex justify-between items-center p-4 border-t sticky bottom-0 bg-white">
                            ...
                            <div class="flex space-x-2">
                                <button
                                    class="px-3 py-1 border rounded text-gray-600 hover:bg-gray-100">Anterior</button>
                                <button class="px-3 py-1 border rounded bg-blue-600 text-white">1</button>
                                <button
                                    class="px-3 py-1 border rounded text-gray-600 hover:bg-gray-100">Siguiente</button>
                            </div>
                        </div>
                    </section>
                </main>
